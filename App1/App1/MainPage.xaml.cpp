...
MainPage::MainPage()
{
	...
	itemListView->SelectionChanged += ref new SelectionChangedEventHandler(this, &MainPage::ItemListView_SelectionChanged);
	Window::Current->SizeChanged += ref new WindowSizeChangedEventHandler (this, &MainPage::Window_SizeChanged);
...
void MainPage::SaveState(Platform::Object^ sender, Common::SaveStateEventArgs^ e)
{
...
void MainPage::Window_SizeChanged(Platform::Object^ sender, Windows::UI::Core::WindowSizeChangedEventArgs^ e)
{
	InvalidateVisualState();
}
...
void MainPage::ItemListView_SelectionChanged(Platform::Object^ sender, Windows::UI::Xaml::Controls::SelectionChangedEventArgs^ e)
{
...
Platform::String^ MainPage::DetermineVisualState()
{
	if (!UsingLogicalPageNavigation())
		return "PrimaryView";
